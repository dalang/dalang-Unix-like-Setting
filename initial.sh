...
if [ -d ~/.vim ]; then mv ~/.vim ~/.vim.old; fi
...
# oh-my-zsh
if [ -d ~/.oh-my-zsh ]; then mv ~/.oh-my-zsh ~/.oh-my-zsh.old; fi
...
if [ ! -d ~/.oh-my-zsh/plugins/razor ]; then ln -s ~/dalang-Unix-like-Setting/oh-my-zsh_razor_plugin ~/.oh-my-zsh/plugins/razor; fi
